...
var Mkcert = class {
  ...
  constructor(options) {
    ...
    this.mkcertSavedPath = resolvePath(process2.platform === "win32" ? "mkcert.exe" : "mkcert");
  ...
  async checkMkcert() {
    ...
    if (this.mkcertLocalPath) {
      ...
      this.logger.error(pc.red(`${this.mkcertLocalPath} does not exist, please check the mkcertPath paramter`));
    } else {
